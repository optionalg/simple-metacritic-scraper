...
# Plotting
genre_means_df.plot.bar(x=genre_means_df['genre'], ylim = (0,10), color = 'br')
rating_means_df.plot.bar(x=rating_means_df['rating'], ylim = (0,10), color = 'br')
year_means_df.plot.line(color = 'br', ylim = (4.5,8))
rawdata['user_rating'].plot.kde(xlim=(0,10))
rawdata['critic_rating_val'] = rawdata['critic_rating_val']/10
rawdata['critic_rating_val'].plot.kde(xlim=(0,10))
